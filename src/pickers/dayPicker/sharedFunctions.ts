...
export function buildDays(date: Dayjs, daysOnPage: number) {
 ...
 */
function getBrakepoints(referenceDate: Dayjs): number[] {
...
export function getDefaultEnabledDayPositions(allDays: string[], date: Dayjs): number[] {
